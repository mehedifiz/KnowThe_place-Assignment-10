...
const Error = () => {
    return (
        <div>
            <Helmet>
                <meta charSet="utf-8" />
                <title>404 Not Found | ExploreEasy</title> {/* Updated to match your project name */}
                <link rel="canonical" href="http://mysite.com/404" />
            </Helmet>
            <Header />
            <main className="grid h-[80vh] place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
